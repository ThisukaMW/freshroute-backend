...
export const loginUserController = async (req: Request, res: Response) => {
  try {
    ...
    const response: Record<string, any> = {
      token: result.token,
      user:  result.user, // role is already lowercased in the service
    };
...
export const registerCustomer = async (req: Request, res: Response) => {
  try {
    ...
    // Server-side password validation (mirrors frontend rules)
...
export const resetPasswordController = async (req: Request, res: Response) => {
  ...
  // Also validate the new password on reset
...
import { createNotification } from "../notifications/notification.service.js";
import { sendPasswordChangedEmail, sendAccountLockedEmail } from "../email/email.service.js";
